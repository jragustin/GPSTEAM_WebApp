...
*/
class ContinuousSites extends Component {
    _onButtonClick(){
        console.log('I do nothing yet');
    }
    renderList(){
    	return( this.props.data.continuousSites.map((site) => {
                return(
...
*/
export default graphql(sitesQuery, {options:sitesFetch})(ContinuousSites)
