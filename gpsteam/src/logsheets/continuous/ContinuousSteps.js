...
function getSteps() {
  return ['Fill out Details', 'Select Continuous Observers', 'Select Continuous Contacts'];
}
...
class ContinuousSteps extends React.Component {
  state = {
    activeStep: 0,
  };
...
ContinuousSteps = connect(mapStateToProps, { ...logsheetActions })(ContinuousSteps)


export default withStyles(styles)(ContinuousSteps);